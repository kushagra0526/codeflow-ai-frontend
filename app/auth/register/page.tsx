...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsAnalyzing(true)
      await register(formData.leetcode_username, '', '')
      router.push("/dashboard")
    } catch (err: any) {
      setError(err.message || "Registration failed. Please check your LeetCode username.")
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    We'll analyze your LeetCode profile and create a personalized learning path
                  </p>
                </div>
